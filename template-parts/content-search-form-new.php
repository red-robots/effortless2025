...
//$placeholder = "Search " . get_the_title();
?>
...
if(is_a($queried_object,'WP_Term')&&$tax):
    ...
    <input type="text" name="search" <?php if($placeholder) echo 'placeholder="'.$placeholder.'"';?> <?php if(isset($_GET['search'])) echo 'value="'.$_GET['search'].'"';?>>
</form>